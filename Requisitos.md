...
## Regras de negocios - RNs - (sao caminhos que cada funcionalidade pode tomar. a regra SEMPRE vai esta associada a um requisito funcional.)
...
- [x] os dados da aplicacao precisam estar persisitidos em um banco postgres
